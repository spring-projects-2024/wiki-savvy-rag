...
examples. As validation data, we used the validation split of the MMLU dataset. During training, for a given question, we retrieved the single most similar passage from
