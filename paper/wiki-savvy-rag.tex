...
be replicated on a single consumer-grade GPU in a few hours.
...
This report will outline the steps we took to build our system, the motivations
...
% in realtà, nel paper originale lo facevano già... qual'è davvero il contributo di replug?
