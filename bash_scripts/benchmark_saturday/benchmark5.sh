...
python3 scripts/benchmark/mmlu.py --config_path "configs/llm_vm.yaml" --log_answers True --k_shot 1 --use_rag 1 --inference_type "naive" --n_docs_retrieved 5 --n_samples 500
